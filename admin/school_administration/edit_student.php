...
try {
    ...
    if ($Clean['Process'] == 2) {
        ...
        $Clean['StudentCategory'] = $StudentToEdit->GetStudentCategory();
...
switch ($Clean['Process']) {
    case 3:
        ...
        if (isset($_POST['drdStudentCategory'])) {
            $Clean['StudentCategory'] = strip_tags(trim($_POST['drdStudentCategory']));
        }
        ...
        $NewRecordValidator->ValidateInSelect($Clean['StudentCategory'], $StudentCategoryList, 'Unknown error in student category, please try again.');
        ...
        $StudentToEdit->SetStudentCategory($Clean['StudentCategory']);
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#Country').change(function() {
                $('#State').load('/xhttp_calls/get_all_states.php', {
            ...
            $('#State').change(function() {
                ...
                $.post("/xhttp_calls/get_all_district.php", {
            ...
            $('#District').change(function() {
                ...
                $.post("/xhttp_calls/get_all_cities.php", {
                    SelectedStateID: StateID,
            ...
            $('#ResidentailCountry').change(function() {
                $('#ResidentailState').load('/xhttp_calls/get_all_states.php', {
                    SelectedCountryID: $(this).val()
                });
            });
            ...
            $('#PermanentCountry').change(function() {
                $('#PermanentState').load('/xhttp_calls/get_all_states.php', {
                    SelectedCountryID: $(this).val()
                });
            });
            ...
            $('#NewParent').click(function() {
                ...
                $('#ParentDetailsContainer').load('/xhttp_calls/get_parent_details.php', {
                    SelectedParentID: 0
                });
            });
