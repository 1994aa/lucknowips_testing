...
$StudentCategoryList = array('Regular' => 'Regular', 'RTE' => 'RTE', 'Staff' => 'Staff', 'Free' => 'Free', 'Sub Staff (4th grade)' => 'Sub Staff (4th grade)', 'Vidyagyan' => 'Vidyagyan');
...
switch ($Clean['Process']) {
    ...
    case 7:
        ...
        if (isset($_GET['drdStudentCategory'])) {
            $Clean['StudentCategory'] = $_GET['drdStudentCategory'];
        } elseif (isset($_GET['StudentCategory'])) {
            $Clean['StudentCategory'] = $_GET['StudentCategory'];
        }
        ...
        if ($Clean['StudentCategory'] != '') {
            $RecordValidator->ValidateInSelect($Clean['StudentCategory'], $StudentCategoryList, 'Please select valid student category');
        }
        ...
        $Filters['StudentCategory'] = $Clean['StudentCategory'];
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Students Lists</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <?php //if ($_SESSION['DB'] == 'addedschools_lucknowips_testing-22-23') { ?>
                                <label for="StudentCategory" class="col-lg-2 control-label">Student Category</label>
                                <div class="col-lg-4">
                                    <select class="form-control" name="drdStudentCategory" id="StudentCategory">
                                        <option value="">Select All Student Category</option>
                                        <?php
                                        foreach ($StudentCategoryList as $StudentCategoryID => $StudentCategory) {
                                            echo '<option ' . ($Clean['StudentCategory'] == $StudentCategoryID ? 'selected="selected"' : '') . ' value="' . $StudentCategoryID . '">' . $StudentCategory . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
            ...
            if ($Clean['Process'] == 7 && $HasErrors == false) {
                ...
                if ($Clean['StudentCategory'] != 0) {
                    $ReportHeaderText .= ' StudentCategory: ' . $StudentCategoryList[$Clean['StudentCategory']] . ',';
                }
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            if ($TotalPages > 1) {
                                                ...
                                                $AllParameters = array('Process' => '7', 'AcademicYearID' => $Clean['AcademicYearID'], 'StudentCategory' => $Clean['StudentCategory'], 'ClassID' => $Clean['ClassID'], 'ClassSectionID' => $Clean['ClassSectionID'], 'Gender' => $Clean['Gender'], 'Category' => $Clean['Category'], 'Other' => $Clean['Other'], 'BloodGroup' => $Clean['BloodGroup'], 'StudentName' => $Clean['StudentName'], 'FatherName' => $Clean['FatherName'], 'Status' => $Clean['Status']);
                                        ...
                                        <div class="col-lg-3">
                                            <div class="print-btn-container">
                                                ...
                                                <!--<button id="PrintButton" onclick="$('#print_report').val(2);$('#FormSearchReport').attr('target', '_blank');$('#SubmitSearch').click();$('#print_report').val(0);$('#FormSearchReport').attr('target', '');" type="submit" class="btn btn-primary">Print</button>-->
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $StudentDetails['StudentCategory']; ?></td>
                                                                <td><a href="../fee_management/student_fee_details.php?Process=7&AcademicYearID=<?php echo $Clean['AcademicYearID']; ?>&ClassID=<?php echo $StudentDetails['ClassID']; ?>&ClassSectionID=<?php echo $StudentDetails['ClassSectionID']; ?>&StudentID=<?php echo $StudentID; ?>&Status=<?php echo $StudentDetails['Status']; ?>" target="fee_card_<?php echo $StudentID; ?>">Show</a></td>
                                                                <td><?php echo $StudentDetails['CreateUserName']; ?></td>
                                                                <td><?php echo date('d/m/Y', strtotime($StudentDetails['CreateDate'])); ?></td>
                                                                <td class="print-hidden">
                                                                    <?php
                                                                    if ($Clean['AcademicYearID'] == 3 || $Clean['AcademicYearID'] == 2) {
                                                                    ...
                                                                    if ($LoggedUser->GetUserID() == '1000005') {
                                                                        echo '&nbsp;|&nbsp;';
                                                                        echo '<a href="change_students_fee_structure.php?StudentID=' . $StudentID . '">Change Fee Structure</a>';
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <!--<td class="print-hidden">-->
