...
<style type="text/css">
	.TimeTableParentTable tr td {
		text-align: center;
	}

	.TimeTableParentTable tr th {
		text-align: center;
	}
</style>
		...
		$(function() {
			...
			?>
				...
				$('#Subject').change(function() {
					...
					$.post("/xhttp_calls/get_teachers_by_class_and_subject.php", {
						SelectedDayID: GlobalDayID,
						SelectedSubjectID: SubjectID,
						SelectedClassID: '<?php echo $CurrentClassSection->GetClassID(); ?>',
						SelectedPeriodStartTime: GlobalPeriodStartTime,
						SelectedPeriodEndTime: GlobalPeriodEndTime,
						SelectedPeriodTimingID: GlobalPeriodTimingID
					}, function(data) {
