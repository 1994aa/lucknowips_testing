...
$Clean['ResidentailDistrictID'] = 5847;
...
$Clean['PermanentDistrictID'] = 5847;
...
switch ($Clean['Process']) {
    case 1:
        ...
        $NewStudentDetail->SetStudentCategory($Clean['StudentCategory']);
                            ...
                            <div class="col-lg-4">
                                <select class="form-control" name="drdStudentCategory" id="StudentCategory">
                                    ...
                                    foreach ($StudentCategoryList as $StudentCategoryID => $StudentCategory) {
                                        echo '<option value="' . $StudentCategoryID . '">' . $StudentCategory . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
