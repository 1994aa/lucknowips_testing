...
//only prev. year left now
unset($AcademicYears[1]);
unset($AcademicYears[2]);
// unset($AcademicYears[3]);
unset($AcademicYears[4]);
...
$Clean['NextAcademicYearID'] = 4;  // Set by default of next session 
...
switch ($Clean['Process']) {
    case 1:
        ...
        if ($NewRecordValidator->ValidateInSelect($Clean['ClassID'], $ClassList, 'Unknown error, please try again.')) {
            ...
            $StudentsList = StudentDetail::GetStudentsByClassSectionID($Clean['ClassSectionID'], 'Active', $Clean['AcademicYearID'], true);
    ...
    case 7:
        ...
        $StudentsList = StudentDetail::GetStudentsByClassSectionIDNotPromoted($Clean['ClassSectionID'], 'Active', $Clean['AcademicYearID'], true);
        break;
}
                                                ...
                                                <table width="100%" class="table table-striped table-bordered table-hover" id="DataTableRecords">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">Next Class</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
