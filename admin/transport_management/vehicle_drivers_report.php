                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div>
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="add-new-btn-container"><a href="assign_vehicle_drivers.php" class="btn btn-primary<?php //echo $LoggedUser->HasPermissionForTask(TASK_ADD_MENU) === true ? '' : ' disabled'; 
                                                                                                                                            ?>" role="button">Assign Vehicle Driver</a></div>
