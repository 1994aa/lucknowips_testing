	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			if ($Clean['Process'] == 7 && $HasErrors == false) {
				...
				if ($Clean['Status'] != '') {
					$ReportHeaderText .= 'Student Status: ' . $Clean['Status'] . ' students,';
				}
								...
								<div>
									<div class="row">
										<div class="col-lg-6">
											<?php
											if ($TotalPages > 1) {
												$AllParameters = array('Process' => '7', 'AcademicYearID' => $Clean['AcademicYearID'], 'RouteID' => $Clean['RouteID'], 'AreaWiseFeeID' => $Clean['AreaWiseFeeID'], 'ClassSectionID' => $Clean['ClassSectionID'], 'StudentID' => $Clean['StudentID'], 'ActiveStatus' => $Clean['ActiveStatus'], 'Status' => $Clean['Status']);
												...
												<tbody>
													...
													?>
															<tr>
																...
																<td><?php echo $StudentVehicleDetails['EnrollmentID']; ?></td>
																...
																<td class="print-hidden">
																	...
																	echo '&nbsp;|&nbsp;<a href="student_transport_change_log.php?StudentID=' . $StudentVehicleDetails['StudentID'] . '">View Transport Change Log</a>';
																	?>
																</td>
															</tr>
														<?php
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#Route').change(function() {
				...
				$.post("/xhttp_calls/get_areas_by_routes.php", {
