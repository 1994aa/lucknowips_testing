...
switch ($Clean['Process'])
{
	...
	case 7;
		...
		else if (isset($_GET['txtDescription']))
		{
		...
		{
		    $RecordValidator->ValidateStrings($Clean['Description'], 'Description is required and should be between 4 and 500 characters.', 4, 500);
		}
