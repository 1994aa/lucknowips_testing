...
switch ($Clean['Process'])
{
    case 7:
        ...
        {
            $WorkingDayStartDate = date("Y-m-d", strtotime($WorkingDayStartDate." -1 year"));
        }
        ...
        if ($Clean['AcademicYearID'] == 1)
        {
            $WorkingDaysEndDate = date("Y-m-d", strtotime($WorkingDaysEndDate." -1 year"));
        }
    ...
    case 9:
        if (isset($_POST['drdMonthlyAttedanceRegisterMonth']))
        {
            $Clean['MonthlyAttedanceRegisterMonth'] = (int) $_POST['drdMonthlyAttedanceRegisterMonth'];
        }
                                    ...
                                    <div class="col-lg-12" style="overflow: auto;">
                                        <table width="100%" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>Class</th>
                                                    <th class="text-center" colspan="<?php echo date('t', strtotime($WorkingDayStartDate)) + 2; ?>"><?php echo $AllClasses[$Clean['ClassID']]; ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Attendance Month</th>
                                                    <th class="text-center" colspan="<?php echo date('t', strtotime($WorkingDayStartDate)) + 2; ?>"><?php echo date('M, Y', strtotime($WorkingDayStartDate)); ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Student Name</th>
<?php
