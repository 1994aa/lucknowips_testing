...
switch ($Clean['Process'])
{
	case 1:
		...
		header('location:student_report_card.php?ClassSectionID=' . $Clean['ClassSectionID'] . '&SelectedStudents='.$SelectedStudents . '&SelectedExamType=' . $Clean['SelectedExamType'].'&AcademicYearID='.$Clean['AcademicYearID']);
		exit;
	break;
    ...
    case 7:
        ...
        $StudentsList = StudentDetail::GetStudentsByClassSectionID($Clean['ClassSectionID'], '', $Clean['AcademicYearID']);
