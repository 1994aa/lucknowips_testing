	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#ParentCategory').change(function() {
				...
				$.post("/xhttp_calls/get_sub_category_by_parent_category.php", {
			...
			$('#BookCategory').change(function() {
				...
				$.post("/xhttp_calls/get_books_by_book_category.php", {
					SelectedBookCategoryID: BookCategoryID
				}, function(data) {
					ResultArray = data.split("|*****|");
			...
			$('#Book').change(function() {
				...
				$.post("/xhttp_calls/get_book_copies_by_book.php", {
			...
			$('#IssuedToUserType').change(function() {
				...
				if (IssuedToUserType == 'Student') {
					...
					$.post("/xhttp_calls/get_branch_staff_by_staff_category.php", {
						SelectedStaffCategory: IssuedToUserType
					}, function(data) {
		...
		function GetBookQuotaAndIssueDetails(IssuedToID) {
			...
			$.post("/xhttp_calls/get_books_issue_conditions_by_user_type.php", {
				SelectedUserType: IssuedToUserType,
				SelectedIssuedToID: IssuedToID
			}, function(data) {
