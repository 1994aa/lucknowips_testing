...
$FeeCollectionDetails = FeeCollection::SearchFeeCollectionDetailsNew($TotalRecords, false, $Filters, $Start, $TotalRecords);
...
{   
    if ($FeeCollectionID > 0)
    {
        ...
        foreach ($FeeCollectionBreakUps[$Clean['FeeAcademicYearID']] as $Month => $BreakUpDetails) 
        {
        ...
        $excelWriter->setActiveSheetIndex(0)
            ...
            ->setCellValueExplicit('C' . $index, date('d/m/Y', strtotime($Details['FeeDate'])), PHPExcel_Cell_DataType::TYPE_STRING)
            ->setCellValueExplicit('D' . $index, $Details['FeeTransactionID'], PHPExcel_Cell_DataType::TYPE_STRING)
            // ->setCellValueExplicit('D' . $index, $Details['EnrollmentID'], PHPExcel_Cell_DataType::TYPE_STRING)
			->setCellValueExplicit('E' . $index, $Details['StudentName'], PHPExcel_Cell_DataType::TYPE_STRING)
			->setCellValueExplicit('F' . $index, $Details['ClassName'], PHPExcel_Cell_DataType::TYPE_STRING)
			->setCellValueExplicit('G' . $index, $Details['SectionName'], PHPExcel_Cell_DataType::TYPE_STRING)
			->setCellValueExplicit('H' . $index, $CollectedFeeMonths, PHPExcel_Cell_DataType::TYPE_STRING);
