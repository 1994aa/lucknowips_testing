...
switch ($Clean['Process'])
{
    ...
    case 7:
        ...
        if ($TotalRecords > 0)
        {
            ...
            {
                $RegisteredStudents = StudentRegistration::SearchStudentRegistration($TotalRecords, false, $Filters, 0, $TotalRecords);
                require_once('../excel/student_registration_list_download_xls.php');
                exit;
            }
