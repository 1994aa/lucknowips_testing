...
switch ($Clean['Process'])
{
    ...
    case 7:
        ...
        if ($TotalRecords > 0)
        {
            ...
            {
               $AllAdmittedStudents = StudentRegistration::SearchAdmittedStudents($TotalRecords, false, $Filters, 0, $TotalRecords);
                require_once('../excel/new_admission_list_download_xls.php');
                exit;
            }
            
            $AllAdmittedStudents = StudentRegistration::SearchAdmittedStudents($TotalRecords, false, $Filters, $Start, $TotalRecords);
        }
