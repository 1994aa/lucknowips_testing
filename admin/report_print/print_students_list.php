...
<?php
                                    ...
                                    if (is_array($SiblingParentsList) && count($SiblingParentsList) > 0)
                                    {
                                        foreach ($SiblingParentsList as $ParentID => $ParentDetails)
                                        {
                                            ?>
                                            <tr>
                                                <td rowspan="<?php echo count($ParentDetails['StudentDetails']); ?>">
                                                    <?php echo ++$Counter; ?>
                                                </td>
                                                <td rowspan="<?php echo count($ParentDetails['StudentDetails']); ?>">
                                                    <?php echo $ParentDetails['FatherFirstName'].' '.$ParentDetails['FatherLastName']; ?>
                                                </td>
                                                <td rowspan="<?php echo count($ParentDetails['StudentDetails']); ?>">
                                                    <?php echo $ParentDetails['MotherFirstName'].' '.$ParentDetails['MotherLastName']; ?>
                                                </td>
                                                <td rowspan="<?php echo count($ParentDetails['StudentDetails']); ?>">
                                                    <?php echo $ParentDetails['FatherMobileNumber'].'<br>'.$ParentDetails['MotherMobileNumber']; ?>
                                                </td>
                                                <td rowspan="<?php echo count($ParentDetails['StudentDetails']); ?>">
                                                    <?php echo $ParentDetails['UserName']; ?>
                                                </td>
                                                <?php
                                                    $StudentCounter = 0;
