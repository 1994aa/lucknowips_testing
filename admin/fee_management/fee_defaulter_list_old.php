...
?>                    
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="page-header">Old Defaulter List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <form class="form-horizontal" name="frmRoomReport" action="fee_defaulter_list_old.php" method="get">
...
<?php
                                    if ($TotalPages > 1)
                                    {
                                        $AllParameters = array('Process' => '7', 'AcademicYearID' => $Clean['AcademicYearID'], 'ClassID' => $Clean['ClassID'], 'ClassSectionID' => $Clean['ClassSectionID'], 'StudentID' => $Clean['StudentID'], 'FeeHeadID' => $Clean['FeeHeadID'], 'DueMonths' => $Clean['DueMonths'], 'StudentName' => $Clean['StudentName'], 'Status' => $Clean['Status'], 'MonthList' => $SelectedMonths, 'AdmissionStatus' => $Clean['AdmissionStatus']);
                                        echo UIHelpers::GetPager('fee_defaulter_list_old.php', $TotalPages, $Clean['CurrentPage'], $AllParameters);
                                    }
?>                                        
                                    </div>
                                    <div class="col-lg-6">
...
<?php
                                    ...
                                    if (is_array($DefaulterList) && count($DefaulterList) > 0)
                                    {
                                        ...
                                        foreach ($DefaulterList as $StudentID => $Details)
                                        {
                                            ...
                                            $FeeDefaulterDues = FeeCollection::GetFeeDefaulterDues($StudentID, $FeePriority, $Clean['AcademicYearID'], $PreviousYearDue, date('Y-m-d'));
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-lg-12" id="SMSDetails">
                <form class="form-horizontal" name="AddFeedStudentmarks" action="fee_defaulter_list_old.php" method="get">
                    <div class="form-group">
