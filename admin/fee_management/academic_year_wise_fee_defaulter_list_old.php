...
switch ($Clean['Process'])
{
	...
	case 7:
		...
		//get records count
		FeeCollection::SearchFeeDefaulters2($TotalRecords, true, $Filters, $FeePriority);
		...
		if ($TotalRecords > 0)
		{
			...
			{
				$DefaulterList = FeeCollection::SearchFeeDefaulters2($TotalRecords, false, $Filters, $FeePriority, 0, $TotalRecords);
			}
			else
			{
				$DefaulterList = FeeCollection::SearchFeeDefaulters2($TotalRecords, false, $Filters, $FeePriority, $Start, $Limit);
			}
...
?>
<title>Academic Year Wise Defaulter List</title>
<!-- DataTables CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Academic Year Wise Defaulter List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <form class="form-horizontal" name="frmRoomReport" action="academic_year_wise_fee_defaulter_list_old.php" method="get">
	                                ...
	                                <div class="row">
	                                    <div class="col-lg-6">
											...
											if ($TotalPages > 1)
											{
												...
												echo UIHelpers::GetPager('academic_year_wise_fee_defaulter_list_old.php', $TotalPages, $Clean['CurrentPage'], $AllParameters);
											}
											?>                                        
	                                    </div>
	                                    <div class="col-lg-6">
	                                        <div class="print-btn-container"><button id="PrintButton" type="submit" class="btn btn-primary">Print</button>
												<button disabled id="" onclick="$ ('#get_excel').val (2); $ ('#SubmitSearch').click ();$ ('#get_excel').val (0);" type="submit" class="btn btn-primary">Export to Excel</button>
	                                            ...
	                                            <tbody>
													...
													if (is_array($DefaulterList) && count($DefaulterList) > 0)
													{
														...
														foreach ($DefaulterList as $StudentID => $Details)
														{
															...
															{
																$PreviousDefaultedFees = FeeCollection::GetFeeDefaulterDues2($StudentID, 120, 1, $PreviousYearDue);
															...
															$FeeDefaulterDues = FeeCollection::GetFeeDefaulterDues2($StudentID, $FeePriority, $Clean['AcademicYearID'], $PreviousYearDue);
			                                                ...
			                                                <tr>
																...
																$TotalDue += $StudentFeeHeadDueAmount + $PreviousDueAmount + $PreviousYearDue;
															    $TotalPreviousYearDue += $PreviousYearDue + $PreviousDueAmount;
																
																//var_dump($StudentFeeHeadDueAmount + $PreviousDueAmount);exit;
																?>
			                                                    <td class="text-right"><?php echo number_format($StudentFeeHeadDueAmount + $PreviousDueAmount + $PreviousYearDue, 2); ?></td>
			                                                    <!--<td class="text-right"><?php echo $Details['DueMonths'] . ' Month'; ?></td>-->
			                                                    <td class="print-hidden"><button type="button" class="btn btn-info btn-sm DueDetails" data-toggle="modal" data-target="" value="<?php echo $StudentID; ?>">Details &nbsp;<i class="fa fa-angle-double-right"></i></button></td>
			                                                </tr>
															<?php
														}
													}
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-lg-12" id="SMSDetails">
							<form class="form-horizontal" name="AddFeedStudentmarks" action="academic_year_wise_fee_defaulter_list_old.php" method="get">
								<div class="form-group">
	...
	<script type="text/javascript">
												$ (document).ready (function ()
												{
													...
													$ ('.DueDetails').click (function ()
													{
														...
														$.post ("/xhttp_calls/get_fee_defaulter_dues1.php", {SelectedStudentID: StudentID, AcademicYearID: AcademicYearID, FeePriority: FeePriority}, function ( data )
														{
															ResultArray = data.split ("|*****|");
