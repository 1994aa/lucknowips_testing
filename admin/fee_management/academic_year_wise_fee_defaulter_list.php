												...
												<tbody>
													...
													?>
														<tr>
															...
															<td class="text-right"><?php echo $StudentDetails['PreviousYearDueAmount']; ?></td>
															<?php
															foreach ($FeeHeads as $FeeID => $FeeName) {
															...
															?>
																<td class="text-right"><?php echo (isset($StudentDetails['FeeHeadDetails'][$FeeID]) ? $StudentDetails['FeeHeadDetails'][$FeeID] : 0); ?></td>
															<?php
															}
															?>
															<td class="text-right"><?php echo $StudentDetails['Due'] - $StudentDetails['PreviousYearDueAmount']; ?></td>
															<td class="text-right"><?php echo $StudentDetails['Due']; ?></td>
																	...
																	<div class="modal-dialog" role="document">
																		<div class="modal-content">
																			<div class="modal-header">
																				...
																				<h4 class="modal-title" id="myModalLabel">Transaction Details For Student: <?php echo $StudentDetails['StudentName']; ?></h4>
																			</div>
																			<div class="modal-body">
																				...
																				?>
																					<table width="100%" class="table table-striped table-bordered">
																						...
																						<thead>
																							<tr class="primary">
																								<th colspan="6"><?php echo $monthName; ?> [2020-21]:</th>
																							</tr>
																							<tr>
																								<th>Sr.No.</th>
																								<th>Fee Head</th>
																						...
																						<tbody>
																							...
																							?>
																								<tr>
																									<td><?php echo ++$CounterFeeHead; ?></td>
																									<td><?php echo $FeeDetails['Head']; ?></td>
																									<td class="text-right"><?php echo $FeeDetails['Amount']; ?></td>
																									<td class="text-right"><?php echo $FeeDetails['Due']; ?></td>
																								</tr>
																							<?php
																							}
																							?>
													...
													<tr>
														...
														<th class="text-right"><?php echo $TotalPrevDueAmount; ?></th>
														<?php
