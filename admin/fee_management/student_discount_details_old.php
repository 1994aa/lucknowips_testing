                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <?php
                                            if ($TotalPages > 1) {
                                                $AllParameters = array('Process' => '7', 'DiscountForAYID' => $Clean['DiscountForAYID'], 'DiscountINAYID' => $Clean['DiscountINAYID'], 'ClassID' => $Clean['ClassID'], 'ClassSectionID' => $Clean['ClassSectionID'], 'StudentID' => $Clean['StudentID'], 'StudentName' => $Clean['StudentName'], 'DiscountType' => $Clean['DiscountType'], 'MonthList' => $SelectedMonths);
