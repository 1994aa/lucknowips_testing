                                    ...
                                    <div class="align-center" style="height:700px; width:500px; border:1px solid black; display:block;  border-collapse: collapse;">
                                        ...
                                        <div style="height:120px; width:310px; float:left; margin-top:10px; text-align:center;">
                                            ...
                                            <strong style="line-height:30px;">
                                                <u>Fee Receipt</u>
                                                ( <span id="feeReceiptYear"><?php echo date('Y', strtotime($AcademicYears[$Clean['AcademicYearID']]['StartDate'])) .' - '. date('Y', strtotime($AcademicYears[$Clean['AcademicYearID']]['EndDate'])); ?></span> )
                                            </strong>
                                        </div>
...
?>
                                                            <tr>
                                                                <td align="right" style="padding-right: 4px;"><?php echo number_format(($Details['RestAmount'] > 0) ? $Details['RestAmount'] : 0, 2); ?></td>
                                                            </tr>
<?php
                                                        }
?>
...
<?php
                                                if ($IsAcademicYear2 == false && $AcademicYearID == 2)
                                                {
                                                    $IsAcademicYear2 = true;
                                                }
                                            }
                                        }
                                        ...
                                        foreach ($OtherChargesDetails as $OtherChargesDetailID => $OtherDetails)
                                        {
                                            ...
                                            $CurrentDue = 0;
                                            $CurrentDue = $AmountPayable-$OtherDetails['Amount'];
...
?>
                                           <tr>
                                                ...
                                                <td class="text-right text-danger" align="right" style="padding-right: 4px;"><?php echo number_format($CurrentDue, 2); ?></td>
                                            </tr>
<?php
                                        }
                                    }
?>  
                                                <tr>
                                                    ...
                                                    <th align="right" class="text-right text-danger" style="padding-right: 4px;"><?php echo number_format(($TotalRestAmount > 0) ? $TotalRestAmount : 0, 2);?></th>
                                                </tr>
                                            </tbody>
                                        </table>
                                         ...
                                         <div style="text-align:left; margin-left: 10px; margin-top: 1px;"><strong>Balance Amt.: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><?php echo number_format(($TotalRestAmount > 0) ? $TotalRestAmount : 0, 2);?></div>
...
<?php
    ...
    {
        ?>
        document.getElementById('feeReceiptYear').textContent = '2019 - 2020';
        <?php
    }
?>
