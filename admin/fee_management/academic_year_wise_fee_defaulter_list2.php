	                                ...
	                                <div class="row">
	                                    <div class="col-lg-6">
											...
											if ($TotalPages > 1)
											{
												...
												echo UIHelpers::GetPager('academic_year_wise_fee_defaulter_list.php', $TotalPages, $Clean['CurrentPage'], $AllParameters);
											}
											?>                                        
	                                    </div>
	                                    <div class="col-lg-6">
	                                            ...
	                                            <tbody>
													...
													if (is_array($DefaulterList) && count($DefaulterList) > 0)
													{
														...
														foreach ($DefaulterList as $StudentID => $Details)
														{
															...
															{
																$PreviousDefaultedFees = FeeCollection::GetFeeDefaulterDues1($StudentID, 120, 1, $PreviousYearDue);
															...
															$FeeDefaulterDues = FeeCollection::GetFeeDefaulterDues1($StudentID, $FeePriority, $Clean['AcademicYearID'], $PreviousYearDue);
