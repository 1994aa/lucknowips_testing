...
switch ($Clean['Process'])
{
    ...
    case 7:        
        ...
        {
            $Clean['FeeHeadID'] = (int) $_GET['drdFeeHead'];
        }
        ...
        if ($Clean['AdmissionStatus'] != '' && $Clean['AcademicYearID'] == 2)
        {
            ...
            <div class="row">
                ...
                if ($LoggedUser->GetUserID() == 1000005)
                {
                    ...
                    <div class="col-lg-6 text-right">
                        <h1 class=""><a href="fee_collection_report_old.php" class="btn btn-primary">Old Collection Report</a></h1>
                    </div>
                    <?php
                }
                ?>
...
?>
    ...
    ?>
                            ...
                            <div class="form-group">                            
                                <label for="ChequeStatus" class="col-lg-2 control-label">Cheque Status</label>
                                <div class="col-lg-5">
<?php
...
?>
                                                <tr>
                                                    ...
                                                    <td><?php echo number_format(($Details['TotalAmount'] - $Details['TotalDiscount']) - $Details['AmountPaid'], 2); ?></td>
                                                    ...
                                                    <?php
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            <td>
                                                                ...
                                                                else if (($TotalPayableAmount - $Details['TotalDiscount']) == ($TotalPayableAmount - $Details['TotalDiscount'] - $Details['AmountPaid']))
                                                                {
                                                                    echo 'Concession';
                                                                }
                                                                else
                                                    ...
                                                    <td class="print-hidden"><button type="button" class="btn btn-info btn-sm pull-right FeeDetails" data-FeeCollectionID="<?php echo $FeeCollectionID; ?>" data-toggle="modal" data-target="#ViewFeeDetails" value="<?php echo $FeeCollectionID; ?>">Details &nbsp;<i class="fa fa-angle-double-right"></i></button></td>
...
$(document).ready(function() {
    $('#ViewFeeDetails').on('show.bs.modal', function(e) {
        ...
        AcademicYearID = $('#AcademicYearID :selected').val();
        ...
        $.post("/xhttp_calls/get_fee_collection_details_by_transaction.php", {SelectedFeeCollectionID:feeCollectionID, PostAcademicYearID: AcademicYearID, PostFeeHeadID: FeeHeadID}, function(data)
        {
