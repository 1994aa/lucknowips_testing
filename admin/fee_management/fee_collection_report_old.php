...
?>                    
        ...
        <div id="page-wrapper">
            ...
            <form class="form-horizontal" name="frmRoomReport" action="fee_collection_report_old.php" method="get">
...
<?php
                                    if ($TotalPages > 1)
                                    {
                                        ...
                                        echo UIHelpers::GetPager('fee_collection_report_old.php', $TotalPages, $Clean['CurrentPage'], $AllParameters);
                                    }
?>                                        
                                    </div>
                                    <div class="col-lg-6">
...
<?php
                                                    ...
                                                    if ($LoggedUser->HasPermissionForTask(TASK_FEE_COLLECTION) === true)
                                                    {
                                                        echo '<a href="fee_collection_report_old.php?Process=5&amp;FeeTransactionID=' . $Details['FeeTransactionID'] . '" class="delete-record">Delete</a>&nbsp;|&nbsp;';
                                                    }
                                                    else
                                                    {
                                                        echo 'Delete &nbsp;|&nbsp;';
