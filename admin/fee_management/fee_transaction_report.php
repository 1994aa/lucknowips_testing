        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-6 text-right">
                    <h1 class=""><a href="fee_transaction_report_20_21.php" class="btn btn-primary">Old Fee Transaction Report 20-21</a></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <select name="drdStudentID" id="Student" class="form-control">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <?php
                                            if ($TotalPages > 1) {
                                                $AllParameters = array('Process' => '7', 'AcademicYearID' => $Clean['AcademicYearID'], 'StudentID' => $Clean['StudentID'], 'TransactionDate' => $Clean['TransactionDate'], 'TransactionFromDate' => $Clean['TransactionFromDate'], 'TransactionToDate' => $Clean['TransactionToDate'], 'MobileNumber' => $Clean['MobileNumber'], 'Status' => $Clean['Status'], 'PaymentMode' => $Clean['PaymentMode']);
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="text-right">
                                                                ...
                                                                $Total = number_format($CashAmount + $ChequeAmount + $CardAmount + $BankAmount + $NetTransferAmount + $WalletAmount, 2);
                                                                ?>
                                                                <hr>
