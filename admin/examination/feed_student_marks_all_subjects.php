...
switch ($Clean['Process']) {
	case 1:
		...
		if (!StudentExamMark::SaveStudentSubjectMarks($SubjectMarksToBeSave, $LoggedUser->GetUserID(), $Clean['AcademicYearID'])) {
	...
	case 7:
		...
		$SearchRecordValidator->ValidateInSelect($Clean['AcademicYearID'], $AcademicYears, 'Unknown error, please try again.');
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#AcademicYearID').change(function() {
				...
				//$('option:selected', 'select[name="drdExamType"]').removeAttr('selected');
