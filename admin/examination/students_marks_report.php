...
switch ($Clean['Process']) {
	case 7:
		...
		$SearchRecordValidator->ValidateInSelect($Clean['AcademicYearID'], $AcademicYears, 'Please select valid academic year.');

		$SearchRecordValidator->ValidateInSelect($Clean['ExamTypeID'], $ExamTypeList, 'Please select valid exam type.');

		$AllClasses = Exam::GetExamApplicableClasses($Clean['ExamTypeID'], $Clean['AcademicYearID']);

		$SearchRecordValidator->ValidateInSelect($Clean['ClassID'], $AllClasses, 'Please select valid class.');
		$AllClassSections = Exam::GetExamApplicableClassSections($Clean['ExamTypeID'], $Clean['ClassID'], $Clean['AcademicYearID']);
		...
		$AllSubjects = Exam::GetExamSubjects($Clean['ExamTypeID'], $Clean['ClassSectionID'], 0, true, $Clean['AcademicYearID']);

		$AllStudentList = StudentDetail::GetStudentsByClassSectionID($Clean['ClassSectionID'], 'Active', $Clean['AcademicYearID']);
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#AcademicYearID').change(function() {
				...
				$('select[name="drdExamType"]').find('option[value="0"]').attr("selected", true);
			...
			$('#ExamType').change(function() {
				...
				$.post("/xhttp_calls/get_exam_applicable_classes.php", {
			...
			$('#Class').change(function() {
				...
				$.post("/xhttp_calls/get_exam_applicable_class_sections.php", {
					SelectedExamType: ExamTypeID,
