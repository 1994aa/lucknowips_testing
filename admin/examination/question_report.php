    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#Class').change(function() {
                ...
                $.post("/xhttp_calls/get_subjects_by_class.php", {
            ...
            $('#ClassSubject').change(function() {
                ...
                $.post("/xhttp_calls/get_chapter_by_class_subject.php", {
                    SelectedClassSubjectID: ClassSubjectID
                }, function(data) {
                    ResultArray = data.split("|*****|");
            ...
            $('#Chapter').change(function() {
                ...
                $.post("/xhttp_calls/get_chapter_topics.php", {
