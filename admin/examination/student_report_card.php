                                    ...
                                    <!-- </div>-->
                                     ...
                                     <div class=" text-center" style="border:1px solid black; width:100%; height: 90px;">
                                        ...
                                        <div style= "float:left; margin-left: 9px; text-align:center;">
                                            ...
                                            <span style="font-weight: bold;font-size: 12px;"> Phone : 7521800903-4, Web : e-mail : lucknowips@gmail.com</span><br>
                                            ...
                                            <thead>
                                               <tr> 
                                                <th>SCHOLASTIC AREAS</th>
                                                 <!--<th></th> -->
                                                  <th colspan="6" style="text-align: center;">Term-1</th>
<?php                                                  
...
?>
 <?php                                                  
                                                    if ($ExamTypeID == 1)
                                                     ...
                                                     if ($ExamTypeID == 11)
                                                     {
                                                         echo '<th style="text-align: center;">'.$Details['ExamName'].'</th>';
                                                     }
                                                     if ($ExamTypeID == 12)
                                                     {
                                                         echo '<th style="text-align: center;">'.$Details['ExamName'].'</th>';
                                                     ...
                                                     else if ($ExamTypeID == 13)
                                                     {
                                                         echo '<th style="text-align: center;">MARKS OBT</th>';
                                                         echo '<th style="text-align: center;">GR</th>';
                                                     }
...
<?php
                                                        ...
                                                        if ($ExamTypeID == 8 && $SubjectObtainedMarksGrandTotal > 0)
                                                         ...
                                                         if ($ExamTypeID == 13 && $SubjectObtainedMarksGrandTotal > 0)
                                                         {
                                                            echo '<td style="text-align: center;">'. $SubjectObtainedMarksGrandTotal .'</td>';
