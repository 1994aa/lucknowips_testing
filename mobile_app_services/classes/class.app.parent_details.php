...
// 		$this->GetClassSectionDetails();
	...
	public function GetStudentFeeDetails($StudentID)
    {
        ...
        try
        {
	        $RSSearch = $this->DBObject->Prepare('SELECT aaym.academicYearMonthID, aaym.monthName, aaym.feePriority, fh.feeHead, sfs.amountPayable, fcd.amountPaid,
