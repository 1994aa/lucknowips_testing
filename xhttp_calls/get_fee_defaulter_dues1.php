...
$FeeDefaulterDues = FeeCollection::GetFeeDefaulterDues1($StudentID, $FeePriority, $PreviousYearDue);
...
<?php
    ...
    {
        echo '<div class="alert alert-info">Previous Year Due: <strong>' . $PreviousYearDue . '</strong></div>';
    }
    
	foreach ($FeeDefaulterDues as $Month => $Details) 
	{
		if (count($Details) > 0) 
		{
?>
		<div class="row" id="<?php echo 'RecordTable' . $Month; ?>">
		    <div class="col-lg-12">
		        <table width="100%" class="table table-striped table-bordered">
		        	<thead>
		        		<tr class="primary"><th colspan="6"><?php echo $Month; ?>:</th></tr>
		        		<tr>
		        			<th>Sr.No.</th>
		        			<th>Fee Head</th>
		        			<th>Amount</th>
