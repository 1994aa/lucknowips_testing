...
if (isset($_POST['PostAcademicYearID']))
{
	$PostAcademicYearID = (int) $_POST['PostAcademicYearID'];
}

if (isset($_POST['PostFeeHeadID']))
{
	$PostFeeHeadID = (int) $_POST['PostFeeHeadID'];
}
...
$FeeCollectionDetails = FeeCollection::GetFeeTransactionDetails($FeeCollectionID, $PostAcademicYearID, $PostFeeHeadID);

$OtherChargesDetails = array();

if ($PostAcademicYearID == 0)
{
