...
if (isset($_POST['AcademicYearMonthID']))
{
	$AcademicYearMonthID = $_POST['AcademicYearMonthID'];
}
...
$FeeDefaulterDues[$AcademicYearID] = FeeCollection::GetFeeDefaulterDuesDetailsVishnu($StudentID, $FeePriority, $AcademicYearID, $PreviousYearDue, $EndDate, $AcademicYearMonthID, $DueFromDate, $DueToDate);
...
if ($AcademicYearID == 2) 
{
    ...
    $PreviousYearDue += $PreviousDueAmount;
}

if (isset($_SESSION['DB']) && $_SESSION['DB'] == 'addedschools_lucknowips_testing-21-22')
{
    $PreviousYearDue += FeeCollection::GetAllPreviousYearAmount($StudentID);
}
